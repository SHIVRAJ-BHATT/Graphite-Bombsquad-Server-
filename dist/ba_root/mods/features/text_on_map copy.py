...
class textonmap:
    ...
    def left_watermark(self, text):
        ...
        node = _ba.newnode('text',
                            attrs={
                                'text':u'\ue043[\U0001F451] ༺CREATOR༻:✘ GRAPHITE & ✘ CARBON\n\ue048[\U0001F6E0] 🅾 𝐈𝐧𝐬𝐭𝐚𝐠𝐫𝐚𝐦 ★: Shivraj_bhatt_001',
                                'flatness': 1.0,
                                'h_align': 'left',
                                'v_attach':'bottom',
                                'h_attach':'left',
   ...
   def leaderBoard(self):
        if hasattr(mystats, 'top5Name') and len(mystats.top5Name) >= 5:
            if setti["leaderboard"]["barsBehindName"]:
                self.ss1 = ba.newnode('image', attrs={'scale': (300, 30), 'texture': ba.gettexture('bar'), 'position': (0, -80), 'attach': 'topRight', 'opacity': 0.5, 'color': (0.6, 0.6, 0.6)})
                self.ss2 = ba.newnode('image', attrs={'scale': (300, 30), 'texture': ba.gettexture('bar'), 'position': (0, -115), 'attach': 'topRight', 'opacity': 0.5, 'color': (0.6, 0.6, 0.6)})
                self.ss3 = ba.newnode('image', attrs={'scale': (300, 30), 'texture': ba.gettexture('bar'), 'position': (0, -150), 'attach': 'topRight', 'opacity': 0.5, 'color': (0.6, 0.6, 0.6)})
                self.ss4 = ba.newnode('image', attrs={'scale': (300, 30), 'texture': ba.gettexture('bar'), 'position': (0, -185), 'attach': 'topRight', 'opacity': 0.5, 'color': (0.6, 0.6, 0.6)})
                self.ss5 = ba.newnode('image', attrs={'scale': (300, 30), 'texture': ba.gettexture('bar'), 'position': (0, -220), 'attach': 'topRight', 'opacity': 0.5, 'color': (0.6 0.6, 0.6)})

            self.ss1a = ba.newnode('text', attrs={'text': "#\U0001F947 " + mystats.top5Name[0][:10] + "...", 'flatness': 1.0, 'h_align': 'left', 'h_attach': 'right', 'v_attach': 'top', 'v_align': 'center', 'position': (-140, -80), 'scale': 0.7, 'color': (0.8, 0.8, 0.8)})

            self.ss2a = ba.newnode('text', attrs={'text': "#\U0001F948 " + mystats.top5Name[1][:10] + "...", 'flatness': 1.0, 'h_align': 'left', 'h_attach': 'right', 'v_attach': 'top', 'v_align': 'center', 'position': (-140, -115), 'scale': 0.7, 'color': (0.8, 0.8, 0.8)})

            self.ss3a = ba.newnode('text', attrs={'text': "#\U0001F949 " + mystats.top5Name[2][:10] + "...", 'flatness': 1.0, 'h_align': 'left', 'h_attach': 'right', 'v_attach': 'top', 'v_align': 'center', 'position': (-140, -150), 'scale': 0.7, 'color': (0.8, 0.8, 0.8)})

            self.ss4a = ba.newnode('text', attrs={'text': "#\U0001F949 " + mystats.top5Name[3][:10] + "...", 'flatness': 1.0, 'h_align': 'left', 'h_attach': 'right', 'v_attach': 'top', 'v_align': 'center', 'position': (-140, -185), 'scale': 0.7, 'color': (0.8, 0.8, 0.8)})

            self.ss5a = ba.newnode('text', attrs={'text': "#\U0001F949 " + mystats.top5Name[4][:10] + "...", 'flatness': 1.0, 'h_align': 'left', 'h_attach': 'right', 'v_attach': 'top', 'v_align': 'center', 'position': (-140, -220), 'scale': 0.7, 'color': (0.8, 0.8, 0.8)})